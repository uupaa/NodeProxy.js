...
//  "abort":                NodeProxy_abort,                // NodeProxy#abort():void
    ...
    "addEventListener":     NodeProxy_addEventListener,     // NodeProxy#addEventListener(type:String, callback:Function):this
    "removeEventListener":  NodeProxy_removeEventListener,  // NodeProxy#removeEventListener(type:String, callback:Function):this
    "clearEventListener":   NodeProxy_clearEventListener,   // NodeProxy#clearEventListener():this
    "on":                   NodeProxy_addEventListener,     // NodeProxy#on(type:String, callback:Function):Boolean
    "off":                  NodeProxy_removeEventListener,  // NodeProxy#off(type:String, callback:Function):Boolean
...
//{@assert
    _if(!Valid.type(type, "String"),       "NodeProxy#addEventListener(type)");
    _if(!Valid.type(callback, "Function"), "NodeProxy#addEventListener(,callback)");
//}@assert
...
//{@assert
    _if(!Valid.type(type, "String"),       "NodeProxy#removeEventListener(type)");
    _if(!Valid.type(callback, "Function"), "NodeProxy#removeEventListener(,callback)");
//}@assert
/*
    if (type in this._attachedEvents) {
        return false;
